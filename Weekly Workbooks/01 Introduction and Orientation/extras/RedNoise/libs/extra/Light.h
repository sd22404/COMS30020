...
#define IDENT0 (glm::vec3(2.864524, -0.507219, 0.650000) * 0.35f)
#define IDENT1 (glm::vec3(3.135476, 0.507219, 0.650000) * 0.35f)
#define IDENT2 (glm::vec3(2.864524, -0.507219, -0.650000) * 0.35f)
...
struct Light {
    ...
    glm::vec3 e1{CEIL2 - CEIL0};
    glm::vec3 e2{CEIL1 - CEIL0};
